...
def pow(base, exponent)
    ...
    #recursion calls itself  # 3^3 -> 3^1 3 * 3^2 9 * 3
    
    pow(base, exponent-1) * base 
end

# pow(2, 3) (result(1) * base(2))-> (result(2) * base(2))-> result(4) * 2 = 8
# pow(2, 3) 2 * 2 * 2 4 * 2 = 8
...
def sum_array(array)
    ...
    #recursive call
    sum_array(array[1..-1]) + array.first
...
#     3-dimensional array: [[['some data']]] ['some data']
def flatten(data)
    #base case .is_a
